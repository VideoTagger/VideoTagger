...
namespace vt
{
	...
	template<>
	class rectangle_tracker_factory<vit_rectangle_tracker> : public shape_tracker_factory<rectangle_shape>
	{
	public:
		rectangle_tracker_factory(const std::string& name, const vit_rectangle_tracker::params& tracker_params = {}) :
			shape_tracker_factory<rectangle_shape>{ name }, tracker_params_{ tracker_params } {}
	...
	template<>
	class rectangle_tracker_factory<da_siam_rpn_rectangle_tracker> : public shape_tracker_factory<rectangle_shape>
	{
	public:
		rectangle_tracker_factory(const std::string& name, const da_siam_rpn_rectangle_tracker::params& tracker_params = {}) :
			shape_tracker_factory<rectangle_shape>{ name }, tracker_params_{ tracker_params } {}
	...
	template<>
	class rectangle_tracker_factory<goturn_rectangle_tracker> : public shape_tracker_factory<rectangle_shape>
	{
	public:
		rectangle_tracker_factory(const std::string& name, const goturn_rectangle_tracker::params& tracker_params = {}) :
			shape_tracker_factory<rectangle_shape>{ name }, tracker_params_{ tracker_params } {}
