...
namespace vt
{
	...
	class linear_shape_predictor_factory : public interpolated_shape_predictor_factory<shape_type>
	{
	public:
		linear_shape_predictor_factory(const std::string& name) : interpolated_shape_predictor_factory<shape_type>{ name } {}
