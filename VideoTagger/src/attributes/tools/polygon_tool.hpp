...
namespace vt
{
	...
	{
	public:
		polygon_tool(const std::string& id, const std::string& icon, const std::string& tooltip, const tag& tag, const std::string& attribute_name) :
			shape_tool<polygon_shape>{ id, icon, tooltip, tag, attribute_name } {}
