...
namespace vt
{
	void line_tool::render_overlay(video_id_t video_id, ImVec2 pos, ImVec2 size, ImVec2 tex_size)
	{
		shape_tool<line_shape>::render_overlay(video_id, pos, size, tex_size);
