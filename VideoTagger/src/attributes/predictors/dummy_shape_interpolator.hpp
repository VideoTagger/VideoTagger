...
namespace vt
{
	...
	class dummy_shape_interpolator : public impl::shape_interpolator<shape_type>
	{
	public:
		dummy_shape_interpolator(const std::string& name) : impl::shape_interpolator<shape_type>{ name } {}
