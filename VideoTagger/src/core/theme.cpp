...
namespace vt
{
	static std::unordered_map<theme_color, std::string> color_names
	{
		...
		{ theme_color::window_background, "window.background" },
		{ theme_color::child_background, "child.background" },
		{ theme_color::popup_background, "popup.background" },
	...
	static std::unordered_map<ImGuiCol, theme_color> imgui_color_map
	{
		...
		{ ImGuiCol_WindowBg, theme_color::window_background },
		{ ImGuiCol_ChildBg, theme_color::child_background },
		{ ImGuiCol_PopupBg, theme_color::popup_background },
