...
namespace vt::ui::impl
{
	struct region_data_renderer
	{
		...
		virtual bool render_region_list(event_source source, const std::string& attribute_name, uint32_t attribute_color, class vt::impl::shape_attribute_instance* instance, std::optional<region_id_t>& selected_region) = 0;
