...
namespace vt::ui::impl
{
	struct region_data_renderer
	{
		...
		virtual void context_menu_items(ui::widget_list& items, event_source source, const std::string& tag_name, segment_id segment, video_id_t video_id, class vt::impl::attribute_instance& attribute_instance, region_id_t region_id) = 0;
	};
}
