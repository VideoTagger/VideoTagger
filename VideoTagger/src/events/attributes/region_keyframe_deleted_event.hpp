...
namespace vt
{
	...
	{
	public:
		region_keyframe_deleted_event(const std::string& tag_name, segment_id segment, video_id_t video_id, impl::attribute_instance& attribute_instance, region_id_t region_id, vt::timestamp ts) :
