...
namespace vt
{
	 ...
	 */
	struct segments_moved_event : public multi_segment_event
	{
		segments_moved_event(segment_storage& storage, const segment_id_map& segments, segment_part move_part, timestamp move_offset, bool moved) :
