...
namespace vt::widgets
{
	...
	extern void draw_timeline_widget(const char* id, timeline_state& state, std::optional<selected_segment_data>& selected_timestamp, std::optional<moving_segment_data>& moving_timestamp, bool& dirty_flag, bool& open);
