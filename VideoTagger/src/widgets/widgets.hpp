...
namespace vt::widgets
{
	...
	extern void draw_timeline_widget(timeline_state& state, active_video_group& video_group, tag_storage& tags, std::optional<selected_timestamp_data>& selected_timestamp, std::optional<moving_timestamp_data>& moving_timestamp, bool& dirty_flag, uint64_t id, bool is_group_open);
