...
{
	localization_editor::localization_editor() : ui::window{ "Localization Editor", "localization-editor", "Localization Editor", ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse }, new_lang_popup_{ui::new_popup<ui::new_language_popup>()}, remove_lang_popup_{ui::new_popup<ui::remove_language_popup>()}
	{
		set_icon(icons::translate);
	}

	void localization_editor::on_render()
	{
		auto& langs = ctx_.lang_packs;
